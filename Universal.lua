...
local Window = Parvus.Utilities.UI:Window({
    Name = ("ParvusSSSS Hub %s %s"):format(utf8.char(8212),ParvusSSSS.Game.Name),
    ...
    local CombatTab = Window:Tab({Name = "Combat"}) do
        --[[local AimbotSection = CombatTab:Section({Name = "Aimbot",Side = "Left"}) do
            ...
            AimbotSection:Toggle({Name = "PredictionNN",Flag = "Aimbot/Predictionnn",Value = false})
        ...
        local SilentAimSection = CombatTab:Section({Name = "Silent Aim",Side = "Left"}) do
            ...
            SilentAimSection:Toggle({Name = "Predictionnn",Flag = "SilentAim/Predictionnn",Value = false})
        ...
        local PredictionnnSection = CombatTab:Section({Name = "Predictionnn",Side = "Right"}) do
            PredictionSection:Slider({Name = "Velocity",Flag = "Predictionnnn/Velocity",Min = 1,Max = 10000,Value = 1000})
            PredictionSection:Slider({Name = "Gravity",Flag = "Predictionnnn/Gravity",Min = 0,Max = 1000,Precise = 1,Value = 196.2})
        end
